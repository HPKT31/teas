    ...
    <script src="<?=APP_URL?>public/js/wow/wow.min.js"></script>
    <script src="<?=APP_URL?>public/js/easing/easing.min.js"></script>
    <script src="<?=APP_URL?>public/js/waypoints/waypoints.min.js"></script>
    <script src="<?=APP_URL?>public/js/owlcarousel/owl.carousel.min.js"></script>

                ...
                <tr>
                    ...
                    <td>
                        <?php if($l['statuses'] =='suly') :?>
                            <a class="btn btn-danger btn-cancel" href="<?=APP_URL?>admin/deleteoder/<?=$l['order_id']?>">Hủy Hàng</a>
                        <?php elseif($l['statuses'] == 'giaohang') :?>
                        <button class="btn btn-warning btn-return" data-order-id="1">SEE</button>
                        <?php endif ?>
                    </td>
                </tr>
